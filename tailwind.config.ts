  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        luxe: {
          greige: "hsl(var(--luxe-greige))",
          taupe: "hsl(var(--luxe-taupe))",
          sage: "hsl(var(--luxe-sage))",
          brown: "hsl(var(--luxe-brown))",
          cream: "hsl(var(--luxe-cream))",
          warm: "hsl(var(--luxe-warm))",
        },
        sidebar: {
      ...
      keyframes: {
        ...
        "hero-text": {
          "0%": { opacity: "0", transform: "translateY(30px)", letterSpacing: "0.3em" },
