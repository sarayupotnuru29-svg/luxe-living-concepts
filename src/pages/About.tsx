      ...
      <section className="luxe-section bg-luxe-cream">
        <div className="container mx-auto max-w-4xl">
          <div ref={bio.ref} className={`transition-all duration-700 ${bio.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            ...
            <p className="font-body text-sm tracking-[0.2em] uppercase text-primary mb-8">Managing Director</p>
            <div className="space-y-5 font-body text-sm md:text-base text-muted-foreground leading-relaxed">
              ...
              <p>
                With years of experience crafting premium residential and commercial spaces across Hyderabad, Vijayawada,
                and Vizag, we specialize in transforming visions into living realities. Our approach balances modern aesthetics
                with timeless warmth — ensuring every space feels uniquely yours.
              </p>
              <p>
      ...
      <section className="luxe-section bg-background">
        <div className="container mx-auto">
          ...
          <div ref={values.ref} className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              { title: "Precision", desc: "Every measurement, material, and finish is chosen with meticulous care." },
              { title: "Client First", desc: "Your lifestyle, preferences, and comfort define our creative direction." },
              { title: "Timeless Design", desc: "We craft spaces that remain elegant and relevant for years to come." },
            ].map((v, i) => (
              <div
                key={v.title}
