  ...
  return (
    <main>
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <img
          src={heroBg}
          alt="Luxury interior living space by Luxe Living Concepts"
        ...
        <div className="relative z-10 text-center px-6 max-w-3xl">
          ...
          />
          <p
            className={`font-heading text-xl md:text-3xl italic text-luxe-cream/90 tracking-wider transition-all duration-1000 delay-700 ${
          ...
          <Link
            to="/gallery"
            className={`luxe-btn-outline mt-10 inline-flex border-luxe-cream/60 text-luxe-cream hover:bg-luxe-cream/20 hover:text-luxe-cream transition-all duration-1000 delay-1000 ${
